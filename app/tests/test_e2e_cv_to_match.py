...
def test_e2e_cv_upload_parse_create_candidate_then_match(client, admin_auth, monkeypatch):
    ...
    fake_parsed = {
        ...
        "skills_grouped": {"technical": ["docker", "python", "sql"], "management": [], "business": [], "soft-skills": [], "other": []},
        "skill_hierarchy": [],
        "skill_graph": {},
        ...
        "extracted_skills": [
            {"skill": "python", "confidence": 0.99, "confidence_normalized": 1.0, "source": "lexicon", "evidence": []},
            {"skill": "sql", "confidence": 0.98, "confidence_normalized": 0.99, "source": "lexicon", "evidence": []},
